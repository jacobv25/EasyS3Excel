package main;//snippet-sourcedescription:[main.XferMgrProgress.java demonstrates how to use the S3 transfermanager to upload files to a bucket and show progress of the upload.]
...
public class XferMgrProgress {
    ...
    public static void main(String[] args) {
        final String USAGE = "\n" +
                "Usage:\n" +
                "    main.XferMgrProgress [--recursive] [--pause] <s3_path> <local_path>\n\n" +
                "Where:\n" +
                ...
                "Examples:\n" +
                "    main.XferMgrProgress public_photos/cat_happy.png my_photos/funny_cat.png\n" +
                "    main.XferMgrProgress public_photos my_photos/cat_sad.png\n" +
                "    main.XferMgrProgress public_photos my_photos\n\n";
